...
const TextArea = ({ lebel, type, placeholder, defaultValue, classNames, rules, status, handler }) => {
    return (
        <div className="w-full relative">
            ...
            }} {...rules} type={type ? type : 'text'} defaultValue={defaultValue ? defaultValue : ""} placeholder={placeholder ? placeholder : ''} className={`w-full resize-none p-2 outline-none rounded-md ${classNames}`} />
            {
