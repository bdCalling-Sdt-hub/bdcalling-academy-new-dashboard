    ...
    return (
        <>
            <div className='flex justify-between items-center gap-2'>
                ...
                <Link to={`/add-provide-class-video`} className='flex justify-center items-center bg-blue-500 px-8 py-2 w-fit gap-2 rounded-md text-white'>
                    <FaPlus /> Add Video
                </Link>
            </div>
...
export default ProvideClassVideo
