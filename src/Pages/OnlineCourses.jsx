...
const OnlineCourses = () => {
    ...
    const [requestingCourse, Course, CourseError, refetch] = useGetRequest('course', `/courses?course_type=online`)
        ...
        <>
            <div className="between-center gap-2">
                ...
                <div className="flex justify-end items-center">
                    <Link to={`/add-course?redirect=online-course&type=add`} onClick={() => {
